...
| `adhd-oversight.test.ts` | Tests `isAdhdOversightEnabled` env parsing, redirect preservation on baseline S2 turn 2, deterministic fixes for archived S1/S2/S3 transcripts, LLM fallback + failure handling, and `isOversightEligibleDraft` guards. |
