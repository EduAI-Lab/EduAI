...
This guide covers deploying and using the **EduAI dev server** on a shared Linux host (`dev.eduai.ok.ubc.ca` / `s378`) with the **Turborepo monorepo** on the `development` branch.
