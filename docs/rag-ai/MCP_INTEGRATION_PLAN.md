...
| POST         | `/api/courses`                               | admin  | No                | No                     | P2       | JSON ✅ (also accepts formData) ([#572](https://github.com/EduAI-Lab/EduAI/issues/572)) |
...
| POST         | `/api/courses/:id/enrollments`               | cookie | Yes               | `**idempotencyKey`** ✅ | **P2**   | ✅ ([#572](https://github.com/EduAI-Lab/EduAI/issues/572))                              |
...
| Method                | Path                     | Auth   | User-scoped | Idempotent | MCP tier | MCP-ready notes                                                          |
| --------------------- | ------------------------ | ------ | ----------- | ---------- | -------- | ------------------------------------------------------------------------ |
| GET/POST/PATCH/DELETE | `/api/users`             | admin  | No          | No         | **P2**   | Error envelope ✅ ([#572](https://github.com/EduAI-Lab/EduAI/issues/572)) |
...
| Gap                                                                  | Severity | Status                                                                                                                   |
| -------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------ |
| Inconsistent error envelope (`users.$.ts`, course create, ai-models) | High     | ✅ Resolved ([#572](https://github.com/EduAI-Lab/EduAI/issues/572))                                                       |
| `POST/PATCH /api/courses` uses formData only                         | High     | ✅ JSON accepted; formData retained ([#572](https://github.com/EduAI-Lab/EduAI/issues/572))                               |
| No idempotency on enrollment POST                                    | Medium   | ✅ Resolved ([#572](https://github.com/EduAI-Lab/EduAI/issues/572))                                                       |
| No OpenAPI / JSON Schema                                             | Medium   | ✅ `[openapi/mcp-v1.openapi.yaml](./openapi/mcp-v1.openapi.yaml)` ([#571](https://github.com/EduAI-Lab/EduAI/issues/571)) |
| RAG search not exposed as HTTP route                                 | Low      | OK — MCP calls `findRelevantContent` directly                                                                            |
| #292 RBAC incomplete on some cookie paths                            | Medium   | Open — user-scoped tools; not service-key path                                                                           |
| AI Tutor admin bug triage not wired to Core                          | Low      | ✅ Wired ([#572](https://github.com/EduAI-Lab/EduAI/issues/572))                                                          |
