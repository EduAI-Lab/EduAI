...
| Workflow | Tester(s) | Status | Makes sense? / UI clear? | Security | Bugs |
|---|---|---|---|---|---|
| _e.g. Generate a question set from uploaded course material via AI_ | | Not started | | | |
...
| Workflow | Tester(s) | Status | Makes sense? / UI clear? | Security | Bugs |
|---|---|---|---|---|---|
| _e.g. Confirm students cannot access the Question Maker answer-key / assessment-authoring views_ | | Not started | | | |
