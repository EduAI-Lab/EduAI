...
### Added
- [monorepo] docs: Add deployment topology decision document covering subdomain, path-prefix, and separate-domain approaches with tradeoffs and a recommendation — pending team decision. (#157, @mochi_21, 2026-05-15)
