...
- [core] feat: Admin Chatbot at `/admin/chat` — ADMIN-only assistant with AI SDK tools for platform ops (list/get courses, enrollments, users, bug reports; confirmed writes for user CRUD, enrollment changes, and bug triage). Separate `ChatbotType` sessions (`LEARNING` | `ADMIN`), tool-capable model requirement, and token budgeting for vLLM context windows. ([#PR](https://github.com/EduAI-Lab/EduAI/pull/PR), @superbolt08, 2026-06-16)
- [core] api: API agent readiness ([#572](https://github.com/EduAI-Lab/EduAI/issues/572)) — shared JSON error envelope (`api-error.server.ts`), JSON body support on course create, enrollment POST idempotency keys, and consistent validation responses. ([#PR](https://github.com/EduAI-Lab/EduAI/pull/PR), @superbolt08, 2026-06-16)
- [core] docs: MCP integration ADR ([#570](https://github.com/EduAI-Lab/EduAI/issues/570)), Phase 1 OpenAPI spec ([#571](https://github.com/EduAI-Lab/EduAI/issues/571)), and optional stdio MCP spike ([#573](https://github.com/EduAI-Lab/EduAI/issues/573)) under `docs/rag-ai/` and `tools/mcp-spike/`; production MCP Host Server ([#574](https://github.com/EduAI-Lab/EduAI/issues/574)) remains September. ([#PR](https://github.com/EduAI-Lab/EduAI/pull/PR), @superbolt08, 2026-06-16)
- [ai-tutor] api: Wire admin bug-report triage to Core — `GET/PATCH /admin/bug-reports` forwards the EduAI session cookie to Core instead of a local table. ([#PR](https://github.com/EduAI-Lab/EduAI/pull/PR), @superbolt08, 2026-06-16)
- [core] tests: Unit tests for admin chat tools (`create-admin-chat-tools.test.ts`, `agent-tools.admin-context.test.ts`, `agent-tools.admin-mutations.test.ts`, `agent-tools.course-context.test.ts`); HTTP smoke scripts `admin-chat-smoke.mjs` and `admin-chat-tools-smoke.ts`. ([#PR](https://github.com/EduAI-Lab/EduAI/pull/PR), @superbolt08, 2026-06-16)
