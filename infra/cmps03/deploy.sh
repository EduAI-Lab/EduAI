...
# ROLLBACK path — superseded by ./migrate-qwen35.sh (Qwen3.5-35B-A3B MoE judge).
# Also copy litellm-config.120b.yaml over litellm-config.yaml before running this.
set -euo pipefail
