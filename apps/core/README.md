...
OLLAMA_BASE_URL="http://localhost:11434/"  # s378 dev server: use http://cmps01.ok.ubc.ca:8001/ollama with CMPS01_INTERNAL_KEY; never connect to cmps01 :11434 directly
# VLLM_PORT=8001
