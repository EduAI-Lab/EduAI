 ...
 *   RESEARCH_KNN_LEAVE_ONE_OUT  1 → exclude self prompt from neighbor vote (slower, less optimistic)
 */
...
const DEFAULT_LABELS = resolve(
  process.cwd(),
  "../../../docs/research/data/runs/labels.v1.jsonl",
);
