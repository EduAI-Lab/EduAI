                              ...
                              <TableRow key={invite.id}>
                                ...
                                <TableCell>
                                  ...
                                  {invite.role === "UNIT_ADMIN" &&
                                    invite.authorizedUnits.length > 0 && (
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {role === "STUDENT" && (
                <p className="text-xs text-muted-foreground">
                  Students can be promoted to TA inside a course — a TA is a student with extra
                  course access. There is no separate TA invite.
                </p>
              )}
            </div>
            {role === "UNIT_ADMIN" && (
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              The invitation for {cancelTarget?.email} will be cancelled and its link will stop
              working. This cannot be undone — you can send a fresh invite later.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
