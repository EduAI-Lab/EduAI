...
Always be helpful, accurate, and cite the course materials when using them in your response. Use markdown for formatting. For mathematical expressions, use LaTeX delimiters: inline math with $...$ and display math with $$...$$.`;
