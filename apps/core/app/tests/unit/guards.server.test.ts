...
describe("validateRedirectUrl", () => {
  ...
  it("passes through localhost absolute URLs (dev)", () => {
    expect(validateRedirectUrl("http://localhost:3001/protected")).toBe(
  ...
  it("passes through the production apex domain", () => {
    expect(validateRedirectUrl("https://eduai.ok.ubc.ca/dashboard")).toBe(
      "https://eduai.ok.ubc.ca/dashboard",
    );
  });

  it("passes through a production subdomain", () => {
    expect(validateRedirectUrl("https://tutor.eduai.ok.ubc.ca/home")).toBe(
      "https://tutor.eduai.ok.ubc.ca/home",
    );
  });
