  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
        We use your student number to match your account with Canvas enrolment data so your courses
        sync automatically.
      </p>
      ...
      <Form method="post" className="flex flex-col gap-4">
        ...
        <div
          ...
          style={{
            background: "oklch(0.192 0.055 259 / 0.05)",
            border: "1px solid oklch(0.192 0.055 259 / 0.12)",
          }}
        >
          <svg
            width="15"
          ...
          <span className="text-xs leading-relaxed text-muted-foreground">
            Your student number is only used to match Canvas enrolments. Stored securely, never
            shared.
          </span>
        </div>
