...
export function PressSurface({
  ...
  const motionClass = motionReduced
    ...
    : cn(
        ...
        launching &&
          "z-10 scale-[1.03] border-accent/60 bg-accent/15 shadow-[0_0_0_1px_color-mix(in_oklch,var(--accent)_35%,transparent),0_8px_24px_-6px_color-mix(in_oklch,var(--accent)_25%,transparent)]",
