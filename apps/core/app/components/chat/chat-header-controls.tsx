import { IconBrain, IconFocus } from "@tabler/icons-react";
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="flex items-center gap-2">
            ...
            {focusMode && (
              <span className="inline-flex items-center gap-1 rounded-full bg-primary px-2 py-0.5 text-[10px] font-semibold leading-none text-primary-foreground select-none">
                <IconFocus className="h-3 w-3 shrink-0" strokeWidth={2} />
                On
              </span>
            )}
          </div>
        ...
        <TooltipContent side="bottom">
          <p>Reduces on-screen distractions to help you concentrate.</p>
