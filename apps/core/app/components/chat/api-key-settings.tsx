    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto rounded-[var(--radius-xl)] shadow-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Customize your system prompt and configure API keys to use your personal quotas and
            credits.
          </DialogDescription>
        </DialogHeader>
        ...
        <PageTabs defaultValue={onSystemPromptSave ? "prompt" : "keys"} className="py-1">
          <PageTabsList>
            {onSystemPromptSave && <PageTabsTrigger value="prompt">System prompt</PageTabsTrigger>}
          ...
          <PageTabsContent value="keys" className="space-y-4">
            ...
            <div className="mt-5 rounded-[var(--radius-md)] border border-border bg-muted/40 px-4 py-3 space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <code className="font-mono">vllm:</code> models in chat when configured.
              </p>
              <p className="text-xs text-muted-foreground">
                Docs: <code className="font-mono">docs/rag-ai/VLLM.md</code>,{" "}
                <code className="font-mono">docs/rag-ai/HOW_TO_USE_DEV_SERVER.md</code>
              </p>
            </div>
            ...
            <div className="mt-3 flex items-start gap-2 rounded-[var(--radius-md)] border border-border bg-muted/40 px-4 py-3">
              ...
              <p className="text-xs text-muted-foreground">
                API keys are encrypted and stored securely on the server. They are never exposed to
                other users or returned to the browser.
              </p>
            </div>
          </PageTabsContent>
        </PageTabs>
