...
export const CORE_API_ENDPOINTS: ApiEndpointEntry[] = [
  ...
  entry({
    ...
    readiness: "partial",
    reason: "List invitations — no admin chat tool",
    gaps: ["admin-chat-tool"],
    errorEnvelope: "mixed",
  ...
  entry({
    ...
    path: "/api/invitations",
    readiness: "partial",
    reason: "Creates user invite + sends email — no admin chat tool yet",
    gaps: ["admin-chat-tool"],
    sendsEmail: true,
    errorEnvelope: "mixed",
    routeFile: "routes/api/invitations.ts",
  ...
  entry({
    ...
    readiness: "partial",
    reason: "Revoke invitation — no admin chat tool",
    gaps: ["admin-chat-tool"],
  ...
  entry({
    ...
    path: "/api/invitations/:id",
    readiness: "partial",
    reason: "Resend invitation email — no admin chat tool",
    gaps: ["admin-chat-tool"],
    sendsEmail: true,
    routeFile: "routes/api/invitations.$id.ts",
  }),
  ...
  entry({
    ...
    readiness: "excluded",
    reason: "Canvas OAuth integration — not agent ops",
    errorEnvelope: "canvas",
  ...
  entry({
    ...
    readiness: "excluded",
    reason: "Canvas course picker UI",
    errorEnvelope: "canvas",
    routeFile: "routes/api/canvas.$.ts",
  }),
  entry({
  ...
  entry({
    ...
    readiness: "excluded",
    reason: "Canvas roster link — instructor workflow",
    errorEnvelope: "canvas",
    routeFile: "routes/api/canvas.$.ts",
  }),
