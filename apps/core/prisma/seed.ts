...
const COURSES: SeedCourse[] = [
  {
    ...
    isPublished: true,
    aiInstructions:
      "Use plain-language analogies. Prefer concrete examples over formal definitions.",
    ...
    questions: [
      {
        ...
        answer: "B",
        testable: true,
        createdBy: u.instructorCS,
      },
      {
        n: 2,
        topicSlug: "data_representation",
        type: "MCQ",
      ...
      },
      {
        ...
        reasoningLevel: "ANALYTICAL",
        answer:
          "As inputs grow, inefficient algorithms scale poorly. A poor algorithm on a fast machine is still beaten by a good algorithm on a slow machine for large inputs.",
        testable: true,
        createdBy: u.instructorCS,
      },
      {
        n: 4,
        topicSlug: "digital_literacy",
        type: "LA",
        content:
          "Describe three considerations when evaluating the trustworthiness of an online source.",
        difficulty: "MEDIUM",
        reasoningLevel: "APPLICATION",
        answer:
          "Authorship and credentials, primary vs secondary sourcing, recency of publication, presence of citations, peer review status, and consistency with corroborating sources.",
        testable: false,
        createdBy: u.instructorCS,
      },
      {
        ...
        type: "MCQ",
        content:
          "Which operation typically dominates the cost of a simple linear search over n items?",
        difficulty: "EASY",
        reasoningLevel: "FACTUAL",
        choices: [
  ...
  },
  {
    ...
    isPublished: true,
    aiInstructions:
      "Encourage students to reason through complexity analysis before optimizing code.",
    instructorId: u.instructorCS,
    taIds: [u.taCS],
    ...
    questions: [
      {
        ...
        reasoningLevel: "ANALYTICAL",
        answer:
          "Arrays offer O(1) random access; linked lists offer O(1) insertion/removal at known positions and dynamic size. Choose linked lists when frequent insert/remove dominates and random access is rare.",
        testable: true,
        createdBy: u.instructorCS,
      },
      {
        ...
        reasoningLevel: "APPLICATION",
        answer:
          "Base case: empty range (low > high) returns not-found. Recursive case: compare target to midpoint; recurse left or right. Runs in O(log n).",
        testable: true,
        createdBy: u.instructorCS,
      },
      {
      ...
      },
      {
        ...
        reasoningLevel: "APPLICATION",
        answer:
          "Encapsulation hides internal state behind a stable interface. Example: exposing a mutable internal list lets external code modify it without invariants being preserved (e.g. a Set whose internal array is leaked, allowing duplicates).",
        testable: false,
        createdBy: u.instructorCS,
      },
    ],
    ...
    questions: [
      {
        ...
        reasoningLevel: "ANALYTICAL",
        answer:
          "RISC: small, fixed-size, load-store instructions; simpler pipelining. CISC: variable-length, complex instructions; denser code.",
        testable: true,
        createdBy: u.instructorCS,
      },
      {
        ...
        topicSlug: "pipeline",
        type: "LA",
        secondaryTopicSlugs: ["isa"],
        content:
          "Explain pipeline hazards (data and control). How does data forwarding reduce stalls?",
        difficulty: "HARD",
        reasoningLevel: "ANALYTICAL",
        answer:
          "Data hazards arise when a later instruction needs a not-yet-written result. Control hazards arise on branches. Forwarding routes a result from a later stage directly into a dependent instruction in an earlier stage, avoiding the wait for write-back.",
        testable: true,
        createdBy: u.instructorCS,
      },
      {
  ...
  },
  {
    ...
    isPublished: true,
    aiInstructions:
      "Emphasize geometric intuition; favor diagrams over algebraic manipulation when possible.",
    ...
    questions: [
      {
        ...
        type: "SA",
        content:
          "State the definition of the partial derivative of f(x, y) with respect to x at a point (a, b).",
        difficulty: "EASY",
        reasoningLevel: "FACTUAL",
        answer: "f_x(a,b) = lim_{h->0} [f(a+h, b) - f(a, b)] / h, treating y = b as constant.",
        testable: true,
        createdBy: u.instructorMath,
      },
      {
        n: 2,
        topicSlug: "multiple_integrals",
        type: "LA",
        content:
          "Explain when Fubini's theorem allows switching the order of integration in a double integral.",
        difficulty: "HARD",
        reasoningLevel: "ANALYTICAL",
        answer:
          "When the integrand is absolutely integrable over the region (e.g. continuous on a bounded closed region), the iterated integrals in either order are equal.",
        testable: true,
        createdBy: u.instructorMath,
      },
      {
        n: 3,
        topicSlug: "vector_fields",
        type: "MCQ",
  ...
  },
  {
    ...
    name: "Real Analysis",
    description:
      "Rigorous treatment of limits, continuity, differentiation, and Riemann integration.",
    term: "W2",
    year: 2025,
    startDate: new Date("2026-01-05"),
    endDate: new Date("2026-04-24"),
    ...
    questions: [
      {
        ...
        reasoningLevel: "FACTUAL",
        answer:
          "For every eps > 0 there exists delta > 0 such that |x - a| < delta implies |f(x) - f(a)| < eps.",
        testable: true,
        createdBy: u.instructorMath,
      },
      {
      ...
      },
      {
        ...
        type: "LA",
        content:
          "Sketch a proof that every continuous function on a closed bounded interval is Riemann integrable.",
        difficulty: "HARD",
        reasoningLevel: "ANALYTICAL",
        answer:
          "Continuous on a compact set implies uniformly continuous. Given eps, choose a partition with mesh small enough that the oscillation on each subinterval is below eps/(b-a). Then upper minus lower Riemann sums is < eps. Apply the Riemann criterion.",
        testable: false,
        createdBy: u.instructorMath,
      },
    ],
  },
  {
    ...
    isPublished: true,
    aiInstructions:
      "Always interpret results in plain language after stating the formal conclusion.",
    instructorId: u.instructorMath,
    ...
    questions: [
      ...
      {
        n: 2,
        topicSlug: "estimation",
        type: "SA",
        content: "Define an unbiased estimator and give a one-line example.",
        difficulty: "MEDIUM",
        reasoningLevel: "FACTUAL",
        answer:
          "An estimator T of theta is unbiased if E[T] = theta. Example: the sample mean is unbiased for the population mean.",
        testable: true,
        createdBy: u.instructorMath,
      },
      {
      ...
      {
        n: 4,
        topicSlug: "resampling",
        type: "LA",
        content:
          "Explain the bootstrap procedure for estimating the standard error of a statistic.",
        difficulty: "HARD",
        reasoningLevel: "APPLICATION",
        answer:
          "Resample with replacement from the observed data B times. Compute the statistic on each resample. The standard deviation of the B values approximates the standard error.",
        testable: false,
        createdBy: u.instructorMath,
      },
    ],
  },
  {
    ...
    isPublished: true,
    aiInstructions:
      "Always distinguish training, validation, and test data when discussing model evaluation.",
    instructorId: u.instructorMath,
    ...
    questions: [
      {
        ...
        type: "MCQ",
        content:
          "For an imbalanced binary classifier, which metric is least informative on its own?",
        difficulty: "MEDIUM",
        reasoningLevel: "ANALYTICAL",
        choices: [
      ...
      {
        n: 2,
        topicSlug: "model_selection",
        type: "SA",
        content: "Why do we use a separate validation set in addition to a test set?",
        difficulty: "MEDIUM",
        reasoningLevel: "ANALYTICAL",
        answer:
          "The validation set tunes hyperparameters during training; the test set provides an unbiased estimate of generalization on data not used in any training decisions.",
        testable: true,
        createdBy: u.instructorMath,
      },
      {
        n: 3,
        topicSlug: "supervised",
        type: "MCQ",
      ...
      {
        n: 4,
        topicSlug: "unsupervised",
        type: "LA",
        content: "Compare k-means and hierarchical clustering. When would you prefer each?",
        difficulty: "HARD",
        reasoningLevel: "APPLICATION",
        answer:
          "k-means is fast and scales well but requires choosing k and assumes roughly spherical clusters. Hierarchical clustering is parameter-free in k and produces a dendrogram but scales poorly to large n. Prefer k-means at scale with known k; prefer hierarchical when structure matters and n is moderate.",
        testable: false,
        createdBy: u.instructorMath,
      },
    ],
    ...
    questions: [
      {
        ...
        type: "SA",
        content:
          "Distinguish classical conditioning from operant conditioning with one example each.",
        difficulty: "MEDIUM",
        reasoningLevel: "FACTUAL",
        answer:
          "Classical: a neutral stimulus paired with an unconditioned stimulus elicits a learned response (Pavlovs dog). Operant: behavior is shaped by consequences (rat pressing a lever for food).",
        testable: true,
        createdBy: u.instructorHum,
      },
      {
        n: 2,
        topicSlug: "brain",
        type: "MCQ",
        content:
          "Which brain structure is most associated with the consolidation of long-term memories?",
        difficulty: "EASY",
        reasoningLevel: "FACTUAL",
        choices: [
      ...
      },
      {
        ...
        type: "LA",
        content:
          "Describe the difference between encoding, storage, and retrieval, and give an example of a failure of each.",
        difficulty: "MEDIUM",
        reasoningLevel: "APPLICATION",
        answer:
          "Encoding converts perception into a memory trace; failure is inattention. Storage maintains the trace; failure is decay. Retrieval accesses the trace; failure is tip-of-the-tongue.",
        testable: false,
        createdBy: u.instructorHum,
      },
    ],
    ...
    questions: [
      {
        ...
        answer: "C",
        testable: true,
        createdBy: u.instructorSci,
      },
      {
        n: 2,
        topicSlug: "organelles",
        type: "SA",
        content: "State two distinct functions of the endoplasmic reticulum.",
        difficulty: "EASY",
        reasoningLevel: "FACTUAL",
        answer:
          "Rough ER synthesizes secreted/membrane proteins via ribosomes; smooth ER synthesizes lipids and detoxifies certain compounds.",
        testable: true,
        createdBy: u.instructorSci,
      },
      {
        n: 3,
        topicSlug: "cell_cycle",
        type: "LA",
        content: "Describe the role of cyclin-dependent kinases in the G1/S transition.",
        difficulty: "HARD",
        reasoningLevel: "ANALYTICAL",
        answer:
          "Cyclin-CDK complexes phosphorylate Rb, releasing E2F to drive transcription of S-phase genes. CDK activity is gated by cyclin availability and inhibitor proteins.",
        testable: false,
        createdBy: u.instructorSci,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "LA",
        content:
          "Two carts collide and stick together. Explain why momentum is conserved but kinetic energy is not.",
        difficulty: "MEDIUM",
        reasoningLevel: "APPLICATION",
        answer:
          "Momentum conservation follows from Newtons third law (no external impulse). KE is not conserved because deformation and heat absorb some KE — the collision is inelastic.",
        testable: false,
        createdBy: u.instructorSci,
      },
    ],
    ...
    questions: [
      {
        ...
        type: "MCQ",
        content:
          "Which of the following was NOT a major driver of the early Industrial Revolution in Britain?",
        difficulty: "MEDIUM",
        reasoningLevel: "ANALYTICAL",
        choices: [
      ...
      {
        n: 2,
        topicSlug: "world_wars",
        type: "SA",
        content: "List two short-term and one long-term cause of World War I.",
        difficulty: "MEDIUM",
        reasoningLevel: "ANALYTICAL",
        answer:
          "Short-term: assassination of Archduke Franz Ferdinand; July Crisis alliance escalations. Long-term: arms race / militarism, or imperial rivalries.",
        testable: true,
        createdBy: u.instructorHum,
      },
      {
        n: 3,
        topicSlug: "globalization",
        type: "LA",
        content:
          "Describe two ways late-20th-century globalization differed from earlier global trade networks.",
        difficulty: "HARD",
        reasoningLevel: "APPLICATION",
        answer:
          "Volume and speed of capital flows enabled by digital communications; integration of global supply chains across many jurisdictions versus the bilateral trade patterns dominant earlier.",
        testable: false,
        createdBy: u.instructorHum,
      },
    ],
  },
  {
    ...
    isPublished: true,
    aiInstructions:
      "Focus on structural feedback over surface-level edits; ask for thesis statements early.",
    instructorId: u.instructorHum,
    ...
    questions: [
      {
        ...
        reasoningLevel: "ANALYTICAL",
        answer:
          "A debatable thesis takes an arguable position that a reasonable person could disagree with; a topic sentence introduces a single paragraph and need not be contestable.",
        testable: true,
        createdBy: u.instructorHum,
      },
      {
    ...
    questions: [
      {
        ...
        reasoningLevel: "FACTUAL",
        answer:
          "Maximize overall utility (well-being). Common objection: it can justify harming individuals to benefit a majority, conflicting with rights-based intuitions.",
        testable: true,
        createdBy: u.instructorHum,
      },
      {
...
async function releaseStudentIdClaim(studentNumber: string, keepUserId: string, lookup: string) {
  await prisma.user.updateMany({
    where: {
      OR: [{ studentIdLookup: lookup }, { studentId: studentNumber, studentIdLookup: null }],
      NOT: { id: keepUserId },
    },
...
export async function seedUsers() {
  ...
  const users: SeededUser[] = [
    { id: u.admin, email: "admin@eduai.local", name: "EduAI Admin", role: "ADMIN" },
    {
      ...
      name: "COSC Unit Admin",
      role: "UNIT_ADMIN",
      authorizedUnits: ["COSC"],
    },
    {
      id: u.unitAdminMulti,
      email: "unitadmin.multi@eduai.local",
      name: "Multi-Unit Admin",
      role: "UNIT_ADMIN",
      authorizedUnits: ["MATH", "STAT", "DATA"],
    },
    {
      id: u.instructorCS,
    ...
    {
      id: u.instructorMath,
      email: "instructor.math@eduai.local",
      name: "Dr. Emmy Noether",
      role: "INSTRUCTOR",
    },
    {
      id: u.instructorSci,
      email: "instructor.sci@eduai.local",
      name: "Dr. Marie Curie",
      role: "INSTRUCTOR",
    },
    {
      id: u.instructorHum,
      email: "instructor.hum@eduai.local",
      name: "Dr. Hannah Arendt",
      role: "INSTRUCTOR",
    },
    ...
    },
    {
      ...
      name: "Brooke Kim",
      role: "STUDENT",
      studentNumber: sn.student2,
    },
    {
      id: u.student3,
      email: "student3@eduai.local",
      name: "Cameron Lee",
      role: "STUDENT",
      studentNumber: sn.student3,
    },
    {
      id: u.student4,
      email: "student4@eduai.local",
      name: "Devon Singh",
      role: "STUDENT",
      studentNumber: sn.student4,
    },
    {
      id: u.student5,
      email: "student5@eduai.local",
      name: "Erin Walsh",
      role: "STUDENT",
      studentNumber: sn.student5,
    },
  ];
  ...
  for (const user of users) {
    ...
    if (user.studentNumber && studentIdFields.studentIdLookup) {
      await releaseStudentIdClaim(user.studentNumber, user.id, studentIdFields.studentIdLookup);
    }
...
async function seedBugReports() {
  ...
  const bugs: SeedBug[] = [
    ...
    },
    {
      ...
      status: "RESOLVED",
      context: { activityId: 7, mode: "teach" },
    },
    {
      id: "seed_bug_06",
      source: "QUESTION_MAKER",
      userId: u.instructorHum,
      isAnonymous: true,
    ...
    },
    {
      ...
      status: "UNHANDLED",
      pageUrl: "/courses/cosc101/materials",
    },
    {
      id: "seed_bug_08",
      source: "AI_TUTOR",
      ...
      status: "RESOLVED",
      context: { aiChatSessionId: 42, iterationCount: 1 },
    },
    {
      id: "seed_bug_09",
      source: "QUESTION_MAKER",
      userId: u.instructorMath,
  ...
  const chats: SeedChat[] = [
    {
      ...
      messages: [
        {
          role: "user",
          text: 'Can you explain what "decomposition" means in computational thinking?',
        },
        {
          role: "assistant",
          text: "Decomposition is breaking a complex problem into smaller, more manageable parts you can tackle one at a time. For example, building a website breaks into layout, content, and styling sub-problems.",
        },
    ...
    },
    {
      ...
      messages: [
        ...
        {
          role: "assistant",
          text: "Each bit doubles the number of representable values: n bits give 2^n combinations. 2^8 = 256, so 8 bits cover exactly 256 distinct values (0–255).",
        },
      ],
    },
    {
      ...
      messages: [
        ...
        {
          role: "assistant",
          text: "Choose a linked list when you do frequent insertions/removals at known positions and rarely need random access. Arrays win when you need O(1) indexing and predictable memory locality.",
        },
      ],
    },
    {
      ...
      messages: [
        {
          role: "user",
          text: "In test-driven development, do I write tests before or after the code?",
        },
        {
          role: "assistant",
          text: "Before. In TDD you write a failing unit test first, then write just enough implementation to make it pass, then refactor — the red/green/refactor loop.",
        },
    ...
    },
    {
      ...
      messages: [
        {
          role: "user",
          text: "What does the partial derivative of f(x, y) with respect to x actually measure?",
        },
        {
          role: "assistant",
          text: "It measures how f changes as you nudge x while holding y fixed — the slope of the surface in the x-direction at that point. Geometrically, slice the surface with a plane y = const and take the ordinary derivative of that curve.",
        },
      ],
    },
    {
      ...
      messages: [
        ...
        {
          role: "assistant",
          text: 'Since 0.03 < 0.05, you reject the null hypothesis at the 5% level. Note this does not mean the null is "0.03 likely" — it means data this extreme would occur only 3% of the time if the null were true.',
        },
      ],
    },
    {
      ...
      messages: [
        ...
        {
          role: "assistant",
          text: "Prefer hierarchical clustering when you do not know the number of clusters up front and want a dendrogram to inspect structure, and when n is moderate. Prefer k-means at scale when k is known and clusters are roughly spherical.",
        },
      ],
    },
    {
      ...
      messages: [
        ...
        {
          role: "assistant",
          text: "Classical conditioning pairs a neutral stimulus with one that already triggers a response (Pavlov's dog salivating to a bell). Operant conditioning shapes behavior through consequences — reinforcement or punishment after the behavior (a rat pressing a lever for food).",
        },
      ],
    },
    {
      ...
      messages: [
        {
          role: "user",
          text: "Any general advice for studying across multiple courses this term?",
        },
        {
          role: "assistant",
          text: "Space your review sessions instead of cramming, mix topics within a session (interleaving), and self-test rather than re-reading. A short weekly plan per course keeps things from piling up.",
        },
      ],
    },
  ];
