 ...
 * `npm run test:pict:gen` from tests/models/ai-judge-scoring.pict).
 */
...
const rows = JSON.parse(readFileSync(path.join(repoRoot, 'tests/models/ai-judge-scoring.cases.json'), 'utf8'));
const { aiJudgeScoringOracle } = await import(path.join(repoRoot, 'tests/models/ai-judge-scoring.oracle.ts'));
