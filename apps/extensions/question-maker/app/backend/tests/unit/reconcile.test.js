...
vi.mock("../../src/config/database.js", () => ({
  prisma: {
    course: {
      findMany: (...a) => mockCourseFindMany(...a),
      delete: (...a) => mockCourseDelete(...a),
    },
    topics: {
      findMany: (...a) => mockTopicsFindMany(...a),
      update: (...a) => mockTopicsUpdate(...a),
    },
    variants: {
      findMany: (...a) => mockVariantsFindMany(...a),
      update: (...a) => mockVariantsUpdate(...a),
    },
  },
}));
...
describe("runReconciliation — Topics", () => {
  it("nullifies coreTopicId when Core returns 404", async () => {
    ...
    expect(mockTopicsUpdate).toHaveBeenCalledWith({
      where: { id: "topic-1" },
