...
function accessibleCourseByCode() {
  const course = { id: QM_COURSE_ID, userId: INSTRUCTOR.id, coreCourseId: 'cuid-core-course', code: null };
...
function setupRow(row) {
  ...
  if (row.CourseIdPresent === 'yes' && row.CourseCodePresent === 'yes' && row.CourseAccess === 'yes') {
