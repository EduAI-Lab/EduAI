...
/** Topic names per course template (index matches dev courses: COSC 211, COSC 121, STUDY1, STUDY3, STUDY2, STUDY4, STUDY5) */
export const TOPIC_NAMES_BY_TEMPLATE = [
  [
  ...
  ["Probability", "Random Variables", "Expectation", "Other"],
  ["Logic and proofs", "Graph theory", "Other"],
  ["Introduction", "Human brain", "Social learning", "Other"],
  ["Determinants of Health & Health‑Equity", "Trauma", "Health promotion", "Other"],
  ["Research design", "Data collection and analysis", "Ethics in research", "Other"],
];

/** 5 questions per template: { description, type, topicIndex, questionText, answer, choices?, correctAnswer? } */
export const SEED_QUESTIONS_BY_TEMPLATE = [
  // Template 0: Machine Architecture (COSC 211)
  [
    {
  ...
  // Template 1: Computer Programming II (COSC 121)
  [
    {
    ...
    },
    {
      ...
      topicIndex: 2,
      questionText:
        "What is the average time complexity of searching an unsorted array of n elements?",
      answer: "C",
      choices: [
        { letter: "A", text: "O(1)" },
    ...
    },
    {
      ...
      topicIndex: 3,
      questionText:
        "In most languages, what happens to code after a thrown exception that is not caught in the same function?",
      answer: "D",
      choices: [
        ...
        {
          letter: "D",
          text: "It is skipped and control jumps to the nearest matching catch handler up the call stack",
        },
      ],
      correctAnswer: "D",
    },
  ],
  // Template 2: Introduction to Statistics (STUDY1)
  [
    {
    ...
    },
    {
      ...
      choices: [
        ...
        {
          letter: "C",
          text: "The sampling distribution of the sample mean approaches a normal distribution as n increases, regardless of the population distribution",
        },
        {
          letter: "D",
    ...
    },
    {
      ...
      topicIndex: 2,
      questionText:
        "A 95% confidence interval for a mean is (10, 14). Which is the best interpretation?",
      answer: "A",
      choices: [
        {
          letter: "A",
  ...
  // Template 3: Discrete Math (STUDY3)
  [
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { letter: "B", text: "When every vertex has even degree and the graph is connected" },
  ...
  // Template 4: Introduction to Psychology (STUDY2)
  [
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { letter: "B", text: "Observation and imitation of others, without direct reinforcement" },
  ...
  // Template 5: Introduction to Nursing (STUDY4)
  [
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { letter: "C", text: "Explaining that their feelings are not realistic and should stop" },
        { letter: "D", text: "Using open-ended questions and active listening" },
      ],
      correctAnswer: "D",
    },
  ],
  // Template 6: Scientific Research Methods (STUDY5)
  [
    {
    ...
    },
    {
      ...
      choices: [
        ...
        {
          letter: "B",
          text: "Reliability ensures consistency of measurement; validity ensures we are measuring what we intend to measure",
        },
