    ...
    questions: [
      {
        ...
        type: "MCQ",
        primaryTopicSlug: "computational_thinking",
        coreQuestionN: 1,
        variants: [
          {
      ...
      },
      {
        ...
        type: "MCQ",
        primaryTopicSlug: "data_representation",
        coreQuestionN: 2,
        variants: [
          {
      ...
      },
      {
        ...
        type: "SA",
        primaryTopicSlug: "algorithms_basics",
        coreQuestionN: 3,
        variants: [
          {
    ...
    questions: [
      {
        ...
        type: "SA",
        primaryTopicSlug: "ds_fundamentals",
        coreQuestionN: 1,
        variants: [
          {
        ...
        variants: [
          {
            ...
            isDraft: false,
            answer:
              "Base case: empty range. Recursive case: compare midpoint, recurse on one half. O(log n).",
            choices: null,
        ...
        variants: [
          {
            ...
            isDraft: false,
            answer:
              "Encapsulation hides internal state behind a stable interface; exposing internals can break invariants.",
            choices: null,
            secondaryTopicSlugs: [],
          },
          {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "MCQ",
        primaryTopicSlug: "vector_fields",
        coreQuestionN: 3,
        variants: [
          {
      ...
      },
      {
        ...
        type: "MCQ",
        primaryTopicSlug: "greens_stokes",
        coreQuestionN: 4,
        variants: [
          {
        ...
        variants: [
          {
            ...
            isDraft: false,
            answer:
              "Classical: stimulus pairing (Pavlov). Operant: behavior shaped by consequences (Skinner).",
            choices: null,
            secondaryTopicSlugs: [],
          },
        ],
...
async function seed() {
  ...
  for (const course of COURSES) {
    ...
    for (const [qIdx, question] of course.questions.entries()) {
      ...
      if (!primaryTopic) {
        throw new Error(
          `Unknown primary topic slug ${question.primaryTopicSlug} in ${course.code}`,
        );
      }
