...
export const questionOrderValidationError = (message) =>
...
export const normalizeQuestionOrder = (questionOrder) => {
  ...
  if (questionOrder === null || typeof questionOrder !== "object" || Array.isArray(questionOrder)) {
  ...
  for (const [rawAssessmentId, rawOrderNumber] of Object.entries(questionOrder)) {
    ...
    if (assessmentId === null) {
      throw questionOrderValidationError(
        "questionOrder assessment IDs must be positive safe integers",
      );
    }
