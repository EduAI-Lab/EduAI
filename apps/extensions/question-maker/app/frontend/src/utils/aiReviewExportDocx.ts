...
export async function buildAiReviewDocxBlob(
      ...
      new TableRow({
        children: [
          ...
          new TableCell({
            children: [
              cellParagraph(
                r.conceptual_equivalence != null ? String(r.conceptual_equivalence) : "-",
              ),
            ],
          }),
          new TableCell({
            children: [
              cellParagraph(
                r.difficulty_similarity != null ? String(r.difficulty_similarity) : "-",
              ),
            ],
          }),
          new TableCell({
            children: [
              cellParagraph(r.structural_validity != null ? String(r.structural_validity) : "-"),
            ],
          }),
          new TableCell({
            children: [
              cellParagraph(r.answer_correctness != null ? String(r.answer_correctness) : "-"),
            ],
          }),
          new TableCell({
          ...
          new TableCell({
            children: [cellParagraph(r.distinctness != null ? String(r.distinctness) : "-")],
          }),
  ...
  const children: DocxParagraph[] = [
    ...
    new Paragraph({
      children: [new TextRun({ text: "Model: ", bold: true }), new TextRun({ text: result.model })],
      spacing: { after: 80 },
    }),
    new Paragraph({
      children: [
    ...
    new Paragraph({
      children: [
        ...
        new TextRun({
          text: `${baseScore0to100 != null ? baseScore0to100.toFixed(0) : "n/a"} / 100`,
        }),
      ],
      spacing: { after: 80 },
    }),
  ...
  if (totalScoreCalcSummary) {
    children.push(
      new Paragraph({
        children: [
          new TextRun({ text: `Total score calculation: ${totalScoreCalcSummary}`, italics: true }),
        ],
        spacing: { after: 240 },
      }),
    );
