...
function section(id: number, position: number, links: SectionVariantLink[]): AssessmentSection {
  return {
    id,
    assessmentId: 1,
    name: `Section ${id}`,
...
describe("collectAssessmentExportBlocks section ordering", () => {
  it("walks sections by position then links by displayOrder", () => {
    ...
    const assessment: Assessment = {
      ...
      sections: [
        ...
        section(1, 0, [link(10, 1, 3, 0, v3), link(11, 1, 1, 0, v1)]),
      ],
    };
  ...
  it("does not interleave sections when displayOrder overlaps across sections", () => {
    ...
    const assessment: Assessment = {
      ...
      updatedAt: "",
      sections: [
        section(1, 0, [link(10, 1, 1, 0, a0), link(11, 1, 2, 1, a1)]),
        section(2, 1, [link(20, 2, 3, 0, b0), link(21, 2, 4, 1, b1)]),
      ],
    };
