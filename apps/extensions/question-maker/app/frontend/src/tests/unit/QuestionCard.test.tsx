...
describe("QuestionCard", () => {
  ...
  it("fires onView when the card is clicked", () => {
    ...
    render(
      <QuestionCard entry={entry} questionNumber={1} onView={onView} onCreateVariant={vi.fn()} />,
    );
  ...
  it("renders short-answer question types with the plain answer instead of choices", () => {
    ...
    render(
      <QuestionCard entry={entry} questionNumber={2} onView={vi.fn()} onCreateVariant={vi.fn()} />,
    );
