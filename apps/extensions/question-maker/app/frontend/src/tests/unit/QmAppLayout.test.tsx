...
vi.mock('@/hooks/useCourses', () => ({
  useCourses: () => ({ courses: coursesValue, isLoading: isCoursesLoadingValue, fetchCourses: vi.fn() }),
}));
...
vi.mock('@/lib/rbac/nav', () => ({
  ...
  getFooterNavForUser: (_user: any) => [{ key: 'back-to-eduai', title: 'Back to EduAI', href: '/dashboard' }],
}));
