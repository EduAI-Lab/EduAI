...
vi.mock('@/hooks/useAllQuestions', () => ({ useAllQuestions: (...a: any[]) => useAllQuestionsMock(...a) }));
...
function setup(overrides: Partial<{ questions: any[]; total: number; isLoading: boolean; error: string | null }> = {}) {
      ...
      questions: [
        {
          ...
          course: { code: 'COSC101' },
          variants: [{ questionText: 'What is 2+2?', difficulty: 'easy', isAiGenerated: true, isDraft: false }],
        },
      ],
      total: 1,
    });
