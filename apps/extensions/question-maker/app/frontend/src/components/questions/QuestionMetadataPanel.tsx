...
interface QuestionMetadataPanelProps {
  ...
  onChange: (
    field: keyof QuestionMetadataPanelValue,
    value: QuestionMetadataPanelValue[keyof QuestionMetadataPanelValue],
  ) => void;
  topics: Topic[];
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {mode === "variant" ? (
            <p className="text-sm text-muted-foreground py-2">
              {questionTypeLabels[value.questionType]}
            </p>
          ) : (
            <Select
              ...
              {onCreateTopic && (
                <>
                  <Button
                    ...
                    aria-controls="question-metadata-topic-creator"
                    onClick={() => {
                  ...
                  {showTopicCreator && (
                    <div id="question-metadata-topic-creator" className="flex gap-2">
                      <Input
                        value={newTopicName}
                        onChange={(event) => {
