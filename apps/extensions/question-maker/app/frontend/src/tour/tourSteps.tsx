...
export const tourSteps: TourConfig = {
  main: [
    ...
    },
    {
      ...
      content:
        "Upload questions from an existing assignment to have them added to the question bank.",
      placement: "right",
    },
    {
      id: "question-list",
  ...
  assessmentBuilder: [
    ...
    },
    {
      ...
      content:
        "Select as many questions as you like, then use this button to save them into the section.",
      placement: "left",
    },
    {
