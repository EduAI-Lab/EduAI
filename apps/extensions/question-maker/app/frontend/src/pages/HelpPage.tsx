...
const ARTICLES: HelpArticle[] = [
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <ol className="list-inside list-decimal space-y-1">
                        ...
                        <li>
                            If external, enter your provider API key. It is stored for your account in this browser,
                            sent through EduAI services when you use AI, and removed when you sign out.
                        </li>
    ...
    },
    {
        ...
        keywords: 'ai models api keys internal external campus provider gemini openai deepseek anthropic opencode go',
        body: (
            <ul className="list-inside list-disc space-y-1">
                ...
                <li>External: provider-hosted (Google/Gemini, OpenAI, DeepSeek, Anthropic, OpenCode Go). Prompts/data go to that provider.</li>
