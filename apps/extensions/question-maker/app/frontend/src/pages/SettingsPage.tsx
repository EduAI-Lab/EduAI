            ...
            <div className="@container/main flex flex-1 flex-col gap-2">
                <div className="flex flex-col gap-6 py-4 md:py-6">
                    <div className="px-4 lg:px-6">
                        <PageHeading
                            heading="Settings"
                            subheading="Manage your account, AI provider keys, Canvas connection, and accessibility preferences."
                        />
                    </div>
                    <div className="px-4 lg:px-6">
                        <PageTabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            ...
                            {/* ── Providers tab (model providers + Canvas) ──────────── */}
                            <PageTabsContent value="providers">
                                ...
                                {/* Canvas integration — folded into Providers (Core parity) */}
                                <Card className="mt-4">
                                    <CardHeader>
                        ...
                        {/* Account — rendered outside the tabs, mirroring Core */}
