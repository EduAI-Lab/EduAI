                        ...
                        <>
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Keys are stored for this account in this browser and sent through
                                        EduAI services to the selected provider when you use AI. Signing out
                                        removes them from this browser.
                                    </CardDescription>
                                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  <label className="flex items-center gap-3 text-sm">
                    <Checkbox
                      checked={exportPrefs.includeAnswerKey}
                      onCheckedChange={(checked) =>
                        handleExportPrefChange("includeAnswerKey", checked === true)
                      }
                    />
                    Include answer key in exports
                  </label>
                  <label className="flex items-center gap-3 text-sm">
                    <Checkbox
                      checked={exportPrefs.includeAiTag}
                      onCheckedChange={(checked) =>
                        handleExportPrefChange("includeAiTag", checked === true)
                      }
                    />
                    Include AI-generated tag
                  </label>
