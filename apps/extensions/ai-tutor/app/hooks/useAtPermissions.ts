...
export function useAtPermissions() {
  ...
  return useMemo(
    () => ({
      ...
      canImportFromEduAi: permissions.canImportFromEduAi(atUser),
      canBrowseEduAiCatalog: permissions.canBrowseEduAiCatalog(atUser),
      ...
      canSyncEnrollmentsFromEduAi: permissions.canSyncEnrollmentsFromEduAi(atUser),
