...
describe("EditActivityPanel", () => {
  it("renders the current question and choices, with the correct answer marked", () => {
    render(<EditActivityPanel activity={baseActivity()} onSubmit={vi.fn()} onCancel={vi.fn()} />);
  ...
  it("submits the built payload for an MCQ activity", async () => {
    ...
    render(<EditActivityPanel activity={baseActivity()} onSubmit={onSubmit} onCancel={vi.fn()} />);
  ...
  it("calls onCancel and resets the form when Cancel is clicked", () => {
    ...
    render(<EditActivityPanel activity={baseActivity()} onSubmit={vi.fn()} onCancel={onCancel} />);
  ...
  it("resets to the new activity when the activity prop changes", () => {
    ...
    rerender(<EditActivityPanel activity={nextActivity} onSubmit={vi.fn()} onCancel={vi.fn()} />);
