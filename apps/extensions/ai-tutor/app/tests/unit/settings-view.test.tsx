...
let mockUser: AuthUser | null = { id: 'u1', name: 'Ada Lovelace', email: 'ada@example.com', role: 'STUDENT' };
...
describe('SettingsView', () => {
  ...
  it('renders the accessibility tab content, including assistive mode state', () => {
    ...
    expect(
      screen.getByText('Personalize how AI Tutor looks and feels. These settings are optional for everyone.'),
    ).toBeInTheDocument();
  });
