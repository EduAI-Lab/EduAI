...
describe("Activities routes", () => {
  ...
  describe("POST /api/questions/:id/answer", () => {
    ...
    function submitAnswer(app, answerOption = 1) {
      return request(app).post(`/api/questions/${activity.id}/answer`).send({ answerOption });
    }
    ...
    it("keeps attempt sequences independent for concurrent submissions by different students", async () => {
