...
function CommandDialog({
  ...
  /**
   * Forwarded to cmdk's `Command`. Set false when the host filters results
   * itself (e.g. a server-side search), so cmdk doesn't filter them a second
   * time and drop rows the server already matched.
   */
