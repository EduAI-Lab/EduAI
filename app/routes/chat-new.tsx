...
import { ChatWelcomeNew } from "~/components/chat/chat-welcome-new";
import { ChatMessageNew } from "~/components/chat/chat-message-new";
import { ChatInputNew } from "~/components/chat/chat-input-new";
import { ChatTypingIndicatorNew } from "~/components/chat/chat-typing-indicator-new";
...
export default function ChatNew() {
  ...
  // Auto-scrolling is now handled by ChatContainer
                ...
                <div className="max-w-4xl mx-auto space-y-6">
                  {messages.length === 0 ? (
                    ...
                    <>
                      ...
                      {isLoading && <ChatTypingIndicatorNew />}
                    </>
                  )}
                </div>
              </div>
